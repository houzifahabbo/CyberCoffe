...
class _OrderViewState extends State<OrderView> {
  ...
  Widget pickTimeOrLocationCards({required PickTimeOrLocation pickTimeOrLocation}) {
    return Padding(
  ...
  Widget menuCard(double phoneHeight, double phoneWidth) {
    return Expanded(
        ...
        child: Column(children: [
          ...
          SizedBox(width: phoneWidth * 0.9, height: 40, child: FilterButtonsListView(phoneWidth, phoneHeight)),
          SizedBox(width: phoneWidth * 0.9, height: phoneHeight * 0.48, child: ProductCard(phoneWidth, phoneHeight)),
      ]),
    ));
  }
}
